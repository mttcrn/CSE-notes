...
![batch_normalization](./assets/batch_normalization.png)
...
![attention_scores](./assets/attention_scores.png)red: decoder information (skip signal) green: encoder information (gate signal)
